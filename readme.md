...
** NOT CURRENTLY MAINTAINED, don't use this in production **
...
`npm run packdry` | Bundles & runs `npm pack`, create test build of the package as `react-simple-range-version.tgz`
